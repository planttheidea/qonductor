...
test('if _cancelPromise rejects the promise', (t) => {
...
test('if _rejectPromise returns a function that will reject the promise', (t) => {
  const reject = sinon.stub();
...
test('if _resolvePromise returns a function that will resolve the promise', (t) => {
